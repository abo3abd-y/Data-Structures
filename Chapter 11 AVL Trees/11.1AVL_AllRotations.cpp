...
// as you can see here, avl trees are really important because they minimize the time taken to sreach for any elements

// sinces time complexity is dependent on the height of the tree and since avl trees minimize the height of the tree given the elements